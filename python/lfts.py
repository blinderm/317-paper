...
def print_all_line_reflections(): 
  
    print("\nLINE REFLECTIONS")
    
    print("\n\nover 0. + 0.j\n")
    M = make_line_reflection(0., 0.)
    for z in z_arr:
        print str(z) + " --> " + str(upper_plane_to_disk_complex(z)) + " --> " + str(apply_transformation(M, upper_plane_to_disk_complex(z)))


    print("\n\nover 1. + 0.j\n")
    M = make_line_reflection(1., 0.)
    for z in z_arr:
        print str(z) + " --> " + str(upper_plane_to_disk_complex(z)) + " --> " + str(apply_transformation(M, upper_plane_to_disk_complex(z)))


    print("\n\nover 0. + 1.j\n")
    M = make_line_reflection(0., 1.)
    for z in z_arr:
        print str(z) + " --> " + str(upper_plane_to_disk_complex(z)) + " --> " + str(apply_transformation(M, upper_plane_to_disk_complex(z)))
...
def print_all_line_reflection_ends(): 
  
    print("\nLINE REFLECTIONS (END)")
    
    print("\n\nover 0. + 0.j\n")
    M = make_line_reflection_end(0., 0.)
    for z in z_arr:
        print str(z) + " --> " + str(upper_plane_to_disk_complex(z)) + " --> " + str(apply_transformation(M, upper_plane_to_disk_complex(z)))


    print("\n\nover 1. + 0.j\n")
    M = make_line_reflection_end(1., 0.)
    for z in z_arr:
        print str(z) + " --> " + str(upper_plane_to_disk_complex(z)) + " --> " + str(apply_transformation(M, upper_plane_to_disk_complex(z)))


    print("\n\nover 0. + 1.j\n")
    M = make_line_reflection_end(0., 1.)
    for z in z_arr:
        print str(z) + " --> " + str(upper_plane_to_disk_complex(z)) + " --> " + str(apply_transformation(M, upper_plane_to_disk_complex(z)))
...
#print_all_line_reflections()
#print_all_line_reflections_end()
print("\nPOINTS")
for z in z_arr: 
