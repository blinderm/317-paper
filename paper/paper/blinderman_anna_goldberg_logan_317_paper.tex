...
We now present our diagrams\footnote{To generate our diagrams, we used the Geogebra visual algebra tool \cite{geogebra_software} and the corresponding user-made hyperbolic geometry worksheet \cite{hyperbolic_worksheet}.}.
