...
Now, if $B$ is a point on the line given by $OA$ along the ray $\overrightarrow{OA}$ \todo{?}, our construction then maps $B$ to the corresponding $B'$
