...
\end{enumerate}
Using the hyperbolic worksheet in Geogebra, we begin by constructing the point $O = (0,0)$ to establish the origin of the \poincare disk. Then constructing the point $A_2 = (
