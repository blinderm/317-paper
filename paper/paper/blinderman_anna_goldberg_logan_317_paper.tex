...
We now discuss hyperbolic line segments. In our above diagram, $\overline{GH}$ and $\overline{EF}$ are line segments lying on the lines $AB$ and $LK$ respectively. In general, if we have a hyperbolic line $XY$ and $Z$ and $W$ are points lying on $XY$ in the \poincare disk, the $\overline{ZW}$ is defined to be the set of all points on line $XY$ between and including $Z$ and $W$.
