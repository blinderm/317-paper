...
\begin{proof} 
	MIGHT BE EASIER TO JUST REFER TO LEMMAS IN APPENDIX C (STILL NEED TO ASK HER ABOUT GROUP OF LFTS)
...
\end{align*}
Notice that this resultant matrix $M_{f_1}M_{f_2}$ encodes the linear fractional transformation given by $f_1 \circ f_2$, the composition of $f_1$ upon $f_2$ \todo{[LG] it is $f_1$ upon $f_2$, right..? $f_1$ acts on $f_2$ so yeah}. 
\end{proof} 
