...
for some $\lambda \in F$. Expanding this further, we see that we must have 
	...
	\]
Looking at the upper-right and lower-left entries in the two above matrices, we see that $M^2 = \lambda I$ can hold if $a + d = 0$ or if $b = c = 0$ and $a^2 = d^2$. Thus, since $a = -d$ implies that $\Tr(M) = 0$ by definition, our theorem is proved. TODO: SUPPOSED TO MAKE MORE EXPLICIT KAREN'S COMMENT \#1 ON BOTTOM OF PG.~7 IN FEEDBACK?
...
\iffalse
\begin{tabular}{cc}
 \includegraphics[width=65mm]{../images/t1_over_x.png} & \includegraphics[width=65mm]{../images/t1_over_y.png} \\
Triangle $T_1$ over point $X$ & Triangle $T_1$ over point $Y$  \\
& \\
\includegraphics[width=65mm]{../images/t2_over_x.png} & \includegraphics[width=65mm]{../images/t2_over_y.png}\\
...
\iffalse
\begin{tabular}{cc}
 \includegraphics[width=65mm]{../images/t1_over_z.png} & \includegraphics[width=65mm]{../images/t2_over_z.png} \\
