...
\begin{enumerate}
	...
	\item Next, we want to find the hyperbolic circle centered at $O = (0,0)$ whose Euclidean radius has a length equal to the Euclidean distance from $O$ to $g(A_2)'$. In particular, let $d_H((0,0), g(A_2)') = d_E((0,0), g(A_2))$. Therefore, we have that
	\[
