...
Now, below are our diagrams, generated with the Geogebra visual algebra tool\cite{geogebra_software} and a corresponding user-made hyperbolic geometry worksheet\cite{hyperbolic_worksheet}. In this worksheet, the \poincare disk is the unit circle with center $(0,0)$ embedded in the plane $\R^2$. 
