...
\begin{theorem} 
	TODO: MOVE THIS SOMEWHERE? ALSO STATEMENT PHRASING? 
	The composition of linear fractional transformation corresponds to the multiplication of their respective matrix encodings.
\end{theorem}
...
\end{align*}
Notice that this resultant matrix $M_{f_1}M_{f_2}$ encodes the linear fractional transformation given by $f_1 \circ f_2$. 
\end{proof} 
