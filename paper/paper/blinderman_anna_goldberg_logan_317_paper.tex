...
Remarkably, Guggenheimer does not address the behavior of linear fractional transformations of the form in (1) when $z = -\frac{d}{c}$. However, we believe that this case corresponds to the output $\specialend$, which Guggengheimer discusses when distinguishing types of lines defining line reflections. We will return to this issue later when we discuss such line reflections further. 
