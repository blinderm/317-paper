...
We choose $\R$ to be our real, ordered field and go forth to 

We work with two triangles, 

Triangle $T_1$ is given by the points $A_1 = 0 + 0i$, $B_1 = 1 + 0i$, and $C_1 = 0 + 1i$. Triangle $T_2$ is given by the points $A_2 = 3 + 5i$, $B_2 = -4 + 4i$, and $C_2 = 2 - 2i$.
...
\noindent We then use the metric on pg.~103\footnote{???} to find the hyperbolic distance, $d_H$, between $O$ and $A'$. We construct a hyperbolic circle\footnote{which is apparently just a circle} of radius $d_H$ centered at $O$.
