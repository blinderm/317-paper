...
We then use the metric [INSERT THE METRIC YOU USE HERE] to find the hyperbolic distance, $d_H$, between $O$ and $A'$. We construct a circle of radius $d_H$ centered at $O$.
...
SAY WHAT COMPLEXIFICATION ACTUALLY IS LOL
