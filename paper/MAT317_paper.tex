...
However, there is no clear geometric motivation behind this choice anyway. In fact, upon further investigation we find that this restriction entirely unnecessary. To test this, we reflect triangles $T_1$ and $T_2$ as defined above over a new point $Z = (-2, 1)$, which does not satisfy the condition $x > y^2$. 
