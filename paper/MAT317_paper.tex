...
However, there is no clear geometric motivation behind this choice anyway. In fact, upon further investigation we find that this restriction entirely unnecessary. To test this, we reflect triangle $T_1$ as defined above over the point $(-2, 1)$, which does not satisfy the condition $x > y^2$. 
