...
\begin{enumerate}[leftmargin = 4em, itemsep=-.8em]
	...
	\item can partition points in/on/out of disk with $x=y^2$?
...
blah blah blah we can see that line reflections are just point refelctions with $\lambda = -1$ if we include that thing that has the fixed points? 
